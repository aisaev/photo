...
class Location extends DBModel implements \JsonSerializable
{
    ...
    public $allPhotoCnt = 0, $allPrivatePhotoCnt = 0, $photoCnt = 0, $privatePhotoCnt = 0;
    ...
    public function jsonSerialize()
    {
        if (Config::$__mode == Config::MODE_EDIT) {
            ...
            if($this->parent>0) $a['p']=$this->parent;
            ...
            if($this->children!=NULL) {
                ...
                foreach ($this->children as $oc) {
                    $child = [
                        'i'=>$oc->id,
                        'd'=> (Config::$lng==Config::LNG_RU?$oc->descr_r:$oc->descr_e)
                    ];
